...
global.H1 = ({children, ...props}) => <Text {...props} is='h1' f={7}>{children}</Text> 
global.H2 = ({children, ...props}) => <Text {...props} is='h2' f={5}>{children}</Text> 
global.H3 = ({children, ...props}) => <Text {...props} is='h3' f={4}>{children}</Text> 
global.H4 = ({children, ...props}) => <Text {...props} is='h4' f={2}>{children}</Text> 
